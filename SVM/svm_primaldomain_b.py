# -*- coding: utf-8 -*-
"""SVM_PrimalDomain_b.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11eYbmzmuzcuJ2e8uGrE5Vth768BUH_aA
"""
...
def train_svm_sgd(X_train, y_train, X_test, y_test, C, gamma0, T):
...
for C in C_values:
    w, b, losses, train_error, test_error = train_svm_sgd(X_train, y_train, X_test, y_test, C, gamma0, T)
