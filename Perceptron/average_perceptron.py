# -*- coding: utf-8 -*-
"""average_perceptron.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bB38oFZiz6hgS9XgYuUfPUWd3cY8eo4F
"""
...
# Predict Function for Average Perceptron
def average_predict(X, weights):
    return np.sign(X.dot(weights))

# Predict on test data
y_pred = average_predict(X_test, average_weights)
